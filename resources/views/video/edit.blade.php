            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" enctype="multipart/form-data" action="{{ route('video.update',$video->id) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ $video->name }}" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="video_link" type="text"
                                        ...
                                        value="{{ $video->video_link }}" required autocomplete="video_link" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text"
                                        ...
                                        value="{{ $video->description }}" required autocomplete="description" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="quality" type="text"
                                        ...
                                        value="{{ $video->quality}}" required autocomplete="quality" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="release_date" type="date"
                                        ...
                                        value="{{ $video->release_date}}" required autocomplete="release_date" autofocus>
                                            ...
                                            <div class="modal-body">
                                                @foreach ($actors as $actor)
                                                    <label class="checkbox">
                                                        <input type="checkbox" value="{{$actor->id}}" {{(checkedIt($actor->id,$selected_actors)?'checked':'')}} name="actors[]">{{$actor->name}}
                                                    </label>
                                                @endforeach
                                            </div>
                        ...
                        <form id="delete-form" action="{{ route('video.destroy',$video->id) }}" method="POST" style="display: none;">
                            @csrf
